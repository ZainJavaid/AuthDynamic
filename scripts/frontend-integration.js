 ...
 * This file demonstrates how to integrate Authdynamickey with a web frontend
 */

// For React/Vue/Angular applications
export class AuthdynamickeyClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AuthdynamickeyClient(provider, contractAddress);
